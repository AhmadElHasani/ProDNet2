...
namespace MyCourse.Models.Services.Application
{
    public class EfCoreCourseService : ICourseService
    {
        ...
        public EfCoreCourseService(MyCourseDbContext dbContext)    //dipendenza forte da MyCourseDbContext che potrebbe complicarmi il lavoro di testing, ma anche no. Per ora non scrivo altro codice di interposizione.
        {
